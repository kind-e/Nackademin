...
public class FortuneTeller {
    ...
    public String calculate() {
            String ans = (
             "Din framtid är "+ translate.Adjektiv(magicNumbers.calculateA())+"."+
            "Du borde sluta " +translate.Verb(magicNumbers.calculateB())+"."+
            "Vi ser att du snart kommer att skaffa "+translate.Substantiv(magicNumbers.calculateC())+"."+
            "Snart kommer du vilja "+translate.Verb(magicNumbers.calculateD())+", "+
            "men då är det viktigt att du är " +translate.Adjektiv(magicNumbers.calculateE()));
    return ans;
    }
